...
public final class ActivityMainBinding implements ViewBinding {
  ...
  private ActivityMainBinding(@NonNull RelativeLayout rootView, @NonNull Button button,
      @NonNull Button button3, @NonNull ImageButton imageButton2, @NonNull ImageView imageView,
  ...
  public static ActivityMainBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityMainBinding((RelativeLayout) rootView, button, button3, imageButton2,
          imageView, textView);
    }
